        ...
        {activeTab === 'visualizer' ? (
          <div className="flex flex-col items-center justify-center text-center w-full">
            ...
            <div className="mt-4 max-w-2xl px-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pink-500/10 border border-pink-500/25 text-[#FF2DAA] text-[11px] font-mono uppercase tracking-widest mb-2.5 font-bold">
                <Radio className="size-3 animate-pulse" />
                <span>UNTHROTTLED OPUS STREAM · NEWPIPE CORE</span>
              </div>
            ...
            {/* Precision 48-Bar Real-Time Spectrum Visualizer */}
            <div className="flex items-end justify-center gap-1.5 h-20 w-full max-w-xl my-6 px-4">
          ...
          <div className="w-full max-w-3xl h-[460px] overflow-y-auto px-8 py-10 text-center space-y-8 scroll-smooth">
            {lyrics.synced.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-zinc-500 space-y-4">
                ...
                <p className="text-base font-semibold text-zinc-400">Searching YouTube Transcripts...</p>
                <span className="text-xs font-mono text-zinc-600">Enjoy the unthrottled high-fidelity audio stream</span>
              </div>
            )}
          </div>
        )}
